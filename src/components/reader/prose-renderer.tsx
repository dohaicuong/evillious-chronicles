  ...
  return (
    <ReactMarkdown
      components={{
        ...
        h2: ({ children }) => (
          <h2 className="text-style-heading-2 text-fg mt-10 mb-5">{children}</h2>
        ),
        h3: ({ children }) => (
          <h3 className="text-style-heading-3 text-fg mt-8 mb-4">{children}</h3>
        ),
        h4: ({ children }) => (
          <h4 className="text-style-heading-4 text-fg mt-6 mb-3">{children}</h4>
        ),
