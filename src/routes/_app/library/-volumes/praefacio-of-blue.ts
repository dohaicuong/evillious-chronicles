  ...
  chapter: [
    {
      ...
      number: 0,
      title: "Prologue",
      pages: "./praefacio-of-blue/chapters/00-prologue",
    },
    {
      id: "pb-ch1",
      number: 1,
      title: "Chapter 1 · Signs of the Enemy at Sea",
      pages: "./praefacio-of-blue/chapters/01-ch1-signs-of-enemy",
    },
    {
      id: "pb-ch2-s1",
      number: 2,
      title: "Chapter 2 · Hometown of Misgivings",
      pages: "./praefacio-of-blue/chapters/02-ch2-s1-hometown-misgivings",
    },
    {
      id: "pb-ch2-s2",
      number: 3,
      title: "Chapter 2 · The Sorceress and the Forest",
      pages: "./praefacio-of-blue/chapters/03-ch2-s2-sorceress-and-forest",
    },
    {
      id: "pb-ch3-s1",
      number: 4,
      title: "Chapter 3 · The Inside Story on the Girl",
      pages: "./praefacio-of-blue/chapters/04-ch3-s1-inside-story",
    },
    {
      id: "pb-ch3-s2",
      number: 5,
      title: "Chapter 3 · A Heartbeat in the Rain",
      pages: "./praefacio-of-blue/chapters/05-ch3-s2-heartbeat-rain",
    },
    {
      id: "pb-ch4-s1",
      number: 6,
      title: "Chapter 4 · The Monastery on the Seashore",
      pages: "./praefacio-of-blue/chapters/06-ch4-s1-monastery-seashore",
    },
    {
      id: "pb-ch4-s2",
      number: 7,
      title: "Chapter 4 · With That Person",
      pages: "./praefacio-of-blue/chapters/07-ch4-s2-with-that-person",
    },
    {
      id: "pb-epilogue",
      number: 8,
      title: "Epilogue · Prelude of Things to Come",
      pages: "./praefacio-of-blue/chapters/08-epilogue-prelude",
    },
  ],
  afterword: {
    id: "pb-afterword",
    number: 99,
    title: "Afterword",
    pages: "./praefacio-of-blue/chapters/afterword",
  },
});
